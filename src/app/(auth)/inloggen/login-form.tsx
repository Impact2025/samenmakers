    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 border border-hairline text-sm font-semibold text-on-surface hover:border-on-surface transition-colors disabled:opacity-50"
        >
      ...
      <p className="text-center text-body-sm text-outline">
        Nog geen account?{" "}
        <Link href="/aanmelden" className="text-primary font-semibold">
          Aanmelden
        </Link>
      </p>
    </div>
